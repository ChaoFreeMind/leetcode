...
// alphanumerical characters within the string into groups. (i.e. if there are M dashes, the 
// string is split into M+1 groups). The dashes in the given string are possibly misplaced.

// We want each group of characters to be of length K (except for possibly the first group, which 
// could be shorter, but still must contain at least one character). To satisfy this requirement, 
// we will reinsert dashes. Additionally, all the lower case letters in the string must be 
...
public class Solution {
    // Original straightforward, got to be very careful about corner cases
    ...
    // Empty string after conversion case
    // Input: "---"
    // Output ""
